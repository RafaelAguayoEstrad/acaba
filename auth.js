...
function iniciarSesion(event) {
    ...
    if (usuarioValido) {
        Swal.fire({
            ...
            // Almacena el usuario en localStorage y redirige al usuario a la página principal después de iniciar sesión
...
document.getElementById("cerrarSesion").addEventListener("click", function() {
    ...
    window.location.href = "login.html"; // Cambia a la ruta de inicio de sesión
});